You are writing the body of the GitHub release pull request for the Snowplow Flutter tracker.
...
Style:
- If there are 1–2 changes, a simple flat list of `* <description> (#NNN)` bullets — matching the CHANGELOG style — is fine. This matches the PR for 0.9.0.
- If there are 3+ changes, group them under short bold headers ending in a colon, in this order, omitting any group that has no entries:
  - `**New features:**`
  - `**Improvements:**`
  - `**Bug fixes:**`
...
- "Improve ...", "Refactor ...", "Update ...", "Migrate ..." (existing capability) → Improvements
